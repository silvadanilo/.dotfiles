...
plugins=(git capistrano bundler heroku autojump command-not-found python pip github gnu-utils history-substring-search zsh-syntax-highlighting)
...
alias cc='cd ~/sviluppo/onebip && code/script/cleanup.sh && phing clean-dev-logs; cd -'
